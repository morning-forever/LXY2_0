...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		<div class="table-header">新增司机</div>
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form id="myForm" class="form-horizontal" method="post" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="span12">
							<input type="text" id="name" name="name"  style="width: 300px;" value="${driver.name }"/>
						</div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="span12">
							<input type="text" id="tel" name="tel"  style="width: 300px;" value="${driver.tel }"/>
						</div>
					</div>
				</div>
