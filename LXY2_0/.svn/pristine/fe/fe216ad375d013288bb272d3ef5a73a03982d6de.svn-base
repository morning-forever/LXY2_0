...
Location.prototype.fillOptionArea = function(el_id , json) {
	var el	= $('#'+el_id); 
	if (json) {
		var index	= 1;
		var selected_index	= 0;
		$.each(json , function(k , v) {
			var option	= '<option value="'+v.areaId+'">'+v.areaName+'</option>';
			el.append(option);
...
Location.prototype.fillOptionCountry	= function(el_id , json) {
	var el	= $('#'+el_id); 
	if (json) {
		var index	= 1;
		var selected_index	= 0;
		$.each(json , function(k , v) {
			if( 0 == v.hasHotel){
				var option	= '<option value="'+v.countryId+'">'+v.countryName+'</option>';
				el.append(option);
			}else{
				var option	= '<option value="'+v.countryId+'">'+v.countryName+'(可住宿)</option>';
				el.append(option);
			}
...
Location.prototype.fillOptionCity	= function(el_id , json) {
	var el	= $('#'+el_id); 
	if (json) {
		var index	= 1;
		var selected_index	= 0;
