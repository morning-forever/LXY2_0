				...
				<table style="margin-left: 5px;" id="btnmenu">
					<tbody>
						<tr>
							...
							<td>
								<input type="text" class="mysearch" id="tel" style="width: 200px;">
							</td>
							<td>
						...
						<tr>
							<td><a href="admin/lxy/driver/addUI" class="btn btn-small btn-success">新增</a></td>
						</tr>
					</tbody>
				</table>
...
function doEdit(driverId){
	location.href = "admin/lxy/driver/editUI/"+driverId;
}


function doDelete(driverId){
	bootbox.confirm("确定要删除吗？",function(result){
		if(result){
			$.post("admin/lxy/driver/delete/"+driverId,function(res){
