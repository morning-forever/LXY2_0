package com.lx.controller.system.user;
...
import com.lx.entity.system.Role;
...
import com.lx.util.FileDownload;
import com.lx.util.FileUpload;
import com.lx.util.GetPinyin;
import com.lx.util.Jurisdiction;
import com.lx.util.ObjectExcelRead;
import com.lx.util.ObjectExcelView;
import com.lx.util.PageData;
import com.lx.util.PathUtil;
...
public class UserController extends BaseController {
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			...
			List<PageData> listPd = ObjectExcelRead.readExcel(filePath, fileName, 2, 0, 0);	//执行读EXCEL操作,读出的数据导入List 2:从第3行开始；0:从第A列开始；0:第0个sheet
