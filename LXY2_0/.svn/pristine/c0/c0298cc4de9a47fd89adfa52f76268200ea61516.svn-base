...
<script type="text/javascript">
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/happuser/hasU.do',
	...
	function hasE(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/happuser/hasE.do',
	...
	function hasN(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/happuser/hasN.do',
...
<body>
	<form action="admin/happuser/${msg }.do" name="userForm" id="userForm" method="post">
