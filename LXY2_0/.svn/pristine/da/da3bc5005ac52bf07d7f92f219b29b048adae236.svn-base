package com.lx.service.system.appuser;
...
public class AppuserService {
	...
	* 通过id获取数据(包括角色信息)
	*/
	public PageData getUserInfoAByUid(String userId)throws Exception{
		PageData pd = new PageData();
		pd.put("userId", userId);
		return (PageData)dao.findForObject("AppuserMapper.getUserInfoAByUid", pd);
	}
	...
	*/
	public void changePassword(PageData pd)throws Exception{
		dao.update("AppuserMapper.changePassword", pd);
	}
	//======================================================================================
