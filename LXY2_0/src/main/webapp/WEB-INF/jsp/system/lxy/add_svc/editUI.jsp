...
<div class="container-fluid" id="main-container">
	...
	<div class="row-fluid">
		<div class="table-header">编辑接送团地点</div>
		<div id="div_content" class="row-fluid" style="padding-top: 10px;">
			<form id="myForm" class="form-horizontal" method="post" >
				<input type="hidden" id="id" name="id" value="${jstSite.id }">
				
				<div class="control-group">
					<label class="control-label" for="name"><span class="red f12">* </span>地点:</label>
					<div class="controls">
						<div class="span12">
							<textarea id="form-field-11" name="name" class="autosize-transition span12" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 98px; margin-left: 0px; margin-right: 0px; width: 503px;">${jstSite.name}</textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="span12">
							<input type="text" id="km" name="km"  style="width: 300px;" value="${jstSite.km}"/>
						</div>
					</div>
				</div>
...
function save(){
	...
	$.post('admin/lxy/add_svc/edit', formObj , function(res) {
