...
<script type="text/javascript">
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/user/hasU.do',
	...
	function hasE(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/user/hasE.do',
	...
	function hasN(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>admin/user/hasN.do',
...
<body>
	<form action="admin/user/${msg }.do" name="userForm" id="userForm" method="post">
